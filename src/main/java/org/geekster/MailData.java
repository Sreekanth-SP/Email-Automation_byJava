...
public class MailData {
    ...
    public static final String CustomHost = "smtp.gmail.com"; // smtp server address for server information
    public static final String CustomPort = "465"; //ssl port number to achieve ssl
    ...
    public static final String myPassword ="ewrbgexkaxqbgwml"; //use temp passwords or app passwords
